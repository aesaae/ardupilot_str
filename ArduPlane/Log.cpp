...
void Plane::Log_Write_Strain_Data()
{
    struct log_Strain_Data pkt = {
		...
		Str_LW03    : rangefinder.voltage_mv()*0.001f,
		Str_LW02    : rangefinder.voltage_mv()*0.001f,
		Str_LW01    : rangefinder.voltage_mv()*0.001f,
		Str_RW01    : rangefinder.voltage_mv()*0.001f,
		Str_RW02    : rangefinder.voltage_mv()*0.001f,
		Str_RW03    : rangefinder.voltage_mv()*0.001f,
		Str_RW04    : rangefinder.voltage_mv()*0.001f,
		Str_RW05    : rangefinder.voltage_mv()*0.001f,
		Str_RW06    : rangefinder.voltage_mv()*0.001f,
		Tmp_LW06    : rangefinder.voltage_mv()*0.001f,
		Tmp_RW06    : rangefinder.voltage_mv()*0.001f,
    };
    DataFlash.WriteBlock(&pkt, sizeof(pkt));
